def find_max_in_matrix(matrix):
    ...
    def divide_conquer(matrix):
        ...
        # Recursively find maximum in each submatrix
        max_values = [divide_conquer(submatrix) for submatrix in submatrices if any(submatrix)]
    ...
    max_value = divide_conquer(matrix)
